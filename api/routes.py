...
from api.auth import login, register_face_v2, verify_face, get_ip, validate_password
...
auth_bp.route('/validate-password', methods=['POST'])(jwt_middleware(validate_password))
